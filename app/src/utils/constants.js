...
export const WHITE_KING_FULL_NAME = 'white-king';
export const BLACK_KING_FULL_NAME = 'black-king';
export const WHITE_QUEEN_FULL_NAME = 'white-queen';
export const BLACK_QUEEN_FULL_NAME = 'black-queen';
export const WHITE_BISHOP_FULL_NAME = 'white-bishop';
export const BLACK_BISHOP_FULL_NAME = 'black-bishop';
export const WHITE_KNIGHT_FULL_NAME = 'white-knight';
export const BLACK_KNIGHT_FULL_NAME = 'black-knight';
export const WHITE_ROOK_FULL_NAME = 'white-rook';
export const BLACK_ROOK_FULL_NAME = 'black-rook';
export const WHITE_PAWN_FULL_NAME = 'white-pawn';
export const BLACK_PAWN_FULL_NAME = 'black-pawn';

export const PIECE_TO_CSS_CLASS_NAME_MAP = {
  [PIECE_WHITE_KING]: WHITE_KING_FULL_NAME,
  [PIECE_BLACK_KING]: BLACK_KING_FULL_NAME,
  [PIECE_WHITE_QUEEN]: WHITE_QUEEN_FULL_NAME,
  [PIECE_BLACK_QUEEN]: BLACK_QUEEN_FULL_NAME,
  [PIECE_WHITE_BISHOP]: WHITE_BISHOP_FULL_NAME,
  [PIECE_BLACK_BISHOP]: BLACK_BISHOP_FULL_NAME,
  [PIECE_WHITE_KNIGHT]: WHITE_KNIGHT_FULL_NAME,
  [PIECE_BLACK_KNIGHT]: BLACK_KNIGHT_FULL_NAME,
  [PIECE_WHITE_ROOK]: WHITE_ROOK_FULL_NAME,
  [PIECE_BLACK_ROOK]: BLACK_ROOK_FULL_NAME,
  [PIECE_WHITE_PAWN]: WHITE_PAWN_FULL_NAME,
  [PIECE_BLACK_PAWN]: BLACK_PAWN_FULL_NAME,
};
